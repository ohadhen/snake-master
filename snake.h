...
public:
  ...
  vector<pair<int, int>> previewSteps;//new
  void calculateAndPrintPreview();//new
  void handlePreview();//new
  Direction GetNextDirection(int currentX, int currentY, Direction currentDir);//new
